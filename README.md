...
|--------------------------------------------------------|-----------------------------------------------------------------|---------|
| [ml](https://github.com/stars/ddelange/lists/ml)       | NLP, Knowledge Extraction, Computer Vision, ...                 |     879 |
| [dev](https://github.com/stars/ddelange/lists/dev)     | Developer Experience, Life Hacks, CLI Productivity, ...         |     623 |
