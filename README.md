...
|--------------------------------------------------------|-----------------------------------------------------------------|---------|
| [ml](https://github.com/stars/ddelange/lists/ml)       | NLP, Knowledge Extraction, Computer Vision, ...                 |     868 |
| [dev](https://github.com/stars/ddelange/lists/dev)     | Developer Experience, Life Hacks, CLI Productivity, ...         |     597 |
| [db](https://github.com/stars/ddelange/lists/db)       | Databases, Connectors, Converters, ...                          |     283 |
| [etl](https://github.com/stars/ddelange/lists/etl)     | Extract-Transform-Load, Data Wrangling, Data Mining, ...        |     262 |
