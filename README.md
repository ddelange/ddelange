...
|--------------------------------------------------------|-----------------------------------------------------------------|---------|
| [ml](https://github.com/stars/ddelange/lists/ml)       | NLP, Knowledge Extraction, Computer Vision, ...                 |     876 |
| [dev](https://github.com/stars/ddelange/lists/dev)     | Developer Experience, Life Hacks, CLI Productivity, ...         |     605 |
| [db](https://github.com/stars/ddelange/lists/db)       | Databases, Connectors, Converters, ...                          |     287 |
| [etl](https://github.com/stars/ddelange/lists/etl)     | Extract-Transform-Load, Data Wrangling, Data Mining, ...        |     268 |
...
| [fe](https://github.com/stars/ddelange/lists/fe)       | Front-End, Full-Stack, App Development, ...                     |     164 |
